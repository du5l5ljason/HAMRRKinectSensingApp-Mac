...
//-------------------------------------------------------------------------
const XnChar* SAMPLE_XML_PATH = "/Users/Tingfang/Documents/TingfangWorkSpace/OpenNI/Data/SamplesConfig.xml";
...
void KinectOpenNI::init(){
	...
	m_rgbImg = new Buffer24(640, 480, ((640*3+3)/4)*4);
	m_depthImg = new Buffer16(640, 480, ((640*2+3)/4)*4);
}
